...
namespace ACS.Solution.Authentication.Server.Services
{
    ...
    public sealed class ACSService : IACSService
    {
        ...
        public ACSService(IOptionsMonitor<CommunicationServicesSettingsModel> communicationServicesSettingsOptions, ILogger<ACSService> logger, CommunicationIdentityClient identityClient = null)
        {
            _logger = logger;
