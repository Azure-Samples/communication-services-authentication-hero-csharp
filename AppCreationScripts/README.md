...
4. If you have never done it already, in the PowerShell window, install the Microsoft Entra PowerShell modules. For this:
...
- Select the Microsoft Entra you are interested in (in the combo-box below your name on the top right of the browser window)
