...
- Register a Client and Server (Web API) applications in Azure Active Directory (AAD) as part of [On Behalf Of workflow](https://docs.microsoft.com/azure/active-directory/develop/v2-oauth2-on-behalf-of-flow). See instructions below
